    ...
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      <main className="max-w-5xl mx-auto px-4 py-10">
        ...
        {credentialsMissing ? (
          ...
          <div className="bg-[#1a1a1a] border border-white/5 rounded-2xl py-14 text-center px-6">
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" className="text-white/15 mx-auto mb-4">
              <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
            </svg>
            <p className="text-white/50 text-sm font-semibold mb-1">Track list not available</p>
            <p className="text-white/25 text-xs leading-relaxed max-w-xs mx-auto mb-6">
              Spotify restricts track access for this playlist via the API. Open it directly in Spotify to listen.
            </p>
            <a
              href={stored.spotifyUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#1DB954] hover:bg-[#1ed760] active:bg-[#1aa34a] text-black text-sm font-bold px-5 py-2.5 rounded-full transition-colors"
            >
